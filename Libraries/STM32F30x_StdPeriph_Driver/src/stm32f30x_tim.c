				...
				uint16_t TIM_IC2Polarity)
{
	...
	tmpccmr1 &=
	    ((uint16_t) ~ TIM_CCMR1_CC1S) & ((uint16_t) ~ TIM_CCMR1_CC2S);
		       ...
		       uint16_t TIM_ICSelection, uint16_t TIM_ICFilter)
{
	...
	tmpccmr1 &=
	    ((uint32_t) ~ TIM_CCMR1_CC1S) & ((uint32_t) ~ TIM_CCMR1_IC1F);
	tmpccmr1 |=
	    (uint32_t) (TIM_ICSelection |
			(uint32_t) ((uint32_t) TIM_ICFilter << 4));
		       ...
		       uint16_t TIM_ICSelection, uint16_t TIM_ICFilter)
{
	...
	/* Select the Input and set the filter */
	tmpccmr1 &=
	    ((uint32_t) ~ TIM_CCMR1_CC2S) & ((uint32_t) ~ TIM_CCMR1_IC2F);
		       ...
		       uint16_t TIM_ICSelection, uint16_t TIM_ICFilter)
{
	...
	/* Select the Input and set the filter */
	tmpccmr2 &=
	    ((uint16_t) ~ TIM_CCMR1_CC1S) & ((uint16_t) ~ TIM_CCMR2_IC3F);
	tmpccmr2 |=
		       ...
		       uint16_t TIM_ICSelection, uint16_t TIM_ICFilter)
{
	...
	/* Select the Input and set the filter */
	tmpccmr2 &=
	    ((uint16_t) ~ TIM_CCMR1_CC2S) & ((uint16_t) ~ TIM_CCMR1_IC2F);
